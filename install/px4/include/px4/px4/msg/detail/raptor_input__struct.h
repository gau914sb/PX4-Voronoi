...
#ifndef PX4__MSG__DETAIL__RAPTOR_INPUT__STRUCT_H_
#define PX4__MSG__DETAIL__RAPTOR_INPUT__STRUCT_H_
...
enum
{
  px4__msg__RaptorInput__MESSAGE_VERSION = 0ul
};
...
enum
{
  px4__msg__RaptorInput__ACTION_DIM = 4
};

/// Struct defined in msg/RaptorInput in the package px4.
/**
  * Raptor Input
 */
typedef struct px4__msg__RaptorInput
{
...
// Struct for a sequence of px4__msg__RaptorInput.
typedef struct px4__msg__RaptorInput__Sequence
{
...
#endif  // PX4__MSG__DETAIL__RAPTOR_INPUT__STRUCT_H_
