...
#ifndef PX4__MSG__DETAIL__RAPTOR_INPUT__TRAITS_HPP_
#define PX4__MSG__DETAIL__RAPTOR_INPUT__TRAITS_HPP_
...
inline std::string to_yaml(const px4::msg::RaptorInput & msg)
{
  return px4::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4::msg::RaptorInput>()
{
  return "px4::msg::RaptorInput";
}

template<>
inline const char * name<px4::msg::RaptorInput>()
{
  return "px4/msg/RaptorInput";
}

template<>
struct has_fixed_size<px4::msg::RaptorInput>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4::msg::RaptorInput>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4::msg::RaptorInput>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4__MSG__DETAIL__RAPTOR_INPUT__TRAITS_HPP_
