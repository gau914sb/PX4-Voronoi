...
#ifndef PX4__MSG__DETAIL__RAPTOR_STATUS__STRUCT_H_
#define PX4__MSG__DETAIL__RAPTOR_STATUS__STRUCT_H_
...
enum
{
  px4__msg__RaptorStatus__MESSAGE_VERSION = 0ul
};
...
enum
{
  px4__msg__RaptorStatus__EXIT_REASON_NONE = 0
};
...
enum
{
  px4__msg__RaptorStatus__EXIT_REASON_NO_ANGULAR_VELOCITY_UPDATE = 1
};
...
enum
{
  px4__msg__RaptorStatus__EXIT_REASON_NOT_ALL_OBSERVATIONS_SET = 2
};
...
enum
{
  px4__msg__RaptorStatus__EXIT_REASON_ANGULAR_VELOCITY_STALE = 3
};
...
enum
{
  px4__msg__RaptorStatus__EXIT_REASON_LOCAL_POSITION_STALE = 4
};
...
enum
{
  px4__msg__RaptorStatus__EXIT_REASON_ATTITUDE_STALE = 5
};
...
enum
{
  px4__msg__RaptorStatus__EXIT_REASON_EXECUTOR_STATUS_SOURCE_NOT_CONTROL = 6
};

/// Struct defined in msg/RaptorStatus in the package px4.
/**
  * Raptor Status
 */
typedef struct px4__msg__RaptorStatus
{
...
// Struct for a sequence of px4__msg__RaptorStatus.
typedef struct px4__msg__RaptorStatus__Sequence
{
...
#endif  // PX4__MSG__DETAIL__RAPTOR_STATUS__STRUCT_H_
