...
{
  new (message_memory) px4::msg::RaptorInput(_init);
}

void RaptorInput_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::RaptorInput *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RaptorInput_message_member_array[8] = {
  {
    ...
    offsetof(px4::msg::RaptorInput, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RaptorInput, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RaptorInput, active),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RaptorInput, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RaptorInput, orientation),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RaptorInput, linear_velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RaptorInput, angular_velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RaptorInput, previous_action),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<px4::msg::RaptorInput>()
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RaptorInput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, RaptorInput)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RaptorInput_message_type_support_handle;
}
