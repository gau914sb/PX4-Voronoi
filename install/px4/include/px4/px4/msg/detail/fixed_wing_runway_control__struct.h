...
enum
{
  px4__msg__FixedWingRunwayControl__STATE_THROTTLE_RAMP = 0
};
...
enum
{
  px4__msg__FixedWingRunwayControl__STATE_CLAMPED_TO_RUNWAY = 1
};
...
enum
{
  px4__msg__FixedWingRunwayControl__STATE_CLIMBOUT = 2
};
...
enum
{
  px4__msg__FixedWingRunwayControl__STATE_FLYING = 3
};
